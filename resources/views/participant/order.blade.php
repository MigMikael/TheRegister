    ...
    <div class="jumbotron col-md-12 col-xs-12" style="text-align: center;padding-top: 0;padding-bottom: 15px">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-2">
                <a href="{{ url()->previous() }}" class="btn btn-default btn-lg">< กลับ</a>
            </div>
            <div class="col-md-4">
                <a href="{{ url('admin/participant/gain_order/'.$orderData['order_id']) }}" class="btn btn-success btn-lg">บันทึกข้อมูล</a>
            </div>
        </div>
    </div>
@stop